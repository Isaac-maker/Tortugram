...
![Tortugram Banner](banner.png)

# 🐢 Tortugram

**A specialized Telegram streaming client designed for big screens.**  
...
Engineered with large displays in mind, it delivers an intuitive navigation layout tailored for **Android TV, Fire TV, and Tablets**.

### Key Features
* 🎬 **Video-Only Focus:** Automatically filters your Telegram ecosystem to present only video media.
* 📺 **Big Screen Optimization:** Designed for Android TV, Amazon Fire TV, and large-format tablets.
...
Optimizada para pantallas grandes, ofrece una interfaz de navegación intuitiva pensada para **Android TV, Fire TV y Tablets**.
...
* 📺 **Diseñado para Pantallas Grandes:** Interfaz adaptada para Android TV, Amazon Fire TV y tabletas.
